...
import com.boxterra.pyfusion.idea.model.PythonModelBuilderImpl
import com.boxterra.pyfusion.idea.model.data.PythonModelData
import com.boxterra.pyfusion.idea.python.PythonModel
...
class PythonGradleProjectResolverExtension extends AbstractProjectResolverExtension {
    ...
    void populateModuleExtraModels(@NotNull IdeaModule gradleModule, @NotNull DataNode<ModuleData> ideModule) {
        PythonModel pythonModel = resolverCtx.getExtraProject(gradleModule, com.boxterra.pyfusion.idea.python.PythonModel.class)
        if (pythonModel != null) {
